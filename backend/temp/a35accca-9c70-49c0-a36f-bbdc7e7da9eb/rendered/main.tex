...
\makeatletter\@ifundefined{providecolor}{}{%
  \providecolor{OliveGreen}{RGB}{60,128,49}
  \providecolor{SpringGreen}{RGB}{128,128,128}
...
\titlefigurecaption{{\large \bf \rm \vspace{0.15cm}International Journal of Thin Films Science and Technology }{}}
...
\titlerunning{Statistical Analysis of Body Dysmorphic Disorder, Quality of Life, and Social Anxiety in Fire Victims: Path Analysis}

\authorrunning{Abdallah Almahaireh et al.}
