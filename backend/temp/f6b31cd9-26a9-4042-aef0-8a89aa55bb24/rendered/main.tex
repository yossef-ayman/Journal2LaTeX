...
\IfFileExists{default.sty}{\IfFileExists{default.sty}{\IfFileExists{default.sty}{\usepackage{default}}{}}{}}{}

\IfFileExists{multirow.sty}{\IfFileExists{multirow.sty}{\IfFileExists{multirow.sty}{\usepackage{multirow}}{\providecommand\multirow[3]{#3}}}{\providecommand\multirow[3]{#3}}}{\providecommand\multirow[3]{#3}}
\IfFileExists{xcolor.sty}{\IfFileExists{xcolor.sty}{\IfFileExists{xcolor.sty}{\usepackage[table]{xcolor}}{}}{}}{}
\IfFileExists{array.sty}{\IfFileExists{array.sty}{\IfFileExists{array.sty}{\usepackage{array}}{}}{}}{}
\IfFileExists{float.sty}{\IfFileExists{float.sty}{\IfFileExists{float.sty}{\usepackage{float}}{}}{}}{}
\IfFileExists{cuted.sty}{\IfFileExists{cuted.sty}{\IfFileExists{cuted.sty}{\usepackage{cuted}}{\newenvironment{strip}{\par\medskip\noindent\begin{minipage}{\linewidth}}{\end{minipage}\par\medskip}}}{\newenvironment{strip}{\par\medskip\noindent\begin{minipage}{\linewidth}}{\end{minipage}\par\medskip}}}{\newenvironment{strip}{\par\medskip\noindent\begin{minipage}{\linewidth}}{\end{minipage}\par\medskip}}
\IfFileExists{capt-of.sty}{\IfFileExists{capt-of.sty}{\IfFileExists{capt-of.sty}{\usepackage{capt-of}}{\providecommand\captionof[2]{\par\refstepcounter{#1}%
  \textbf{\csname #1name\endcsname\ \csname the#1\endcsname:}\ #2\par}}}{\providecommand\captionof[2]{\par\refstepcounter{#1}%
  \textbf{\csname #1name\endcsname\ \csname the#1\endcsname:}\ #2\par}}}{\providecommand\captionof[2]{\par\refstepcounter{#1}%
  \textbf{\csname #1name\endcsname\ \csname the#1\endcsname:}\ #2\par}}
\IfFileExists{newunicodechar.sty}{\IfFileExists{newunicodechar.sty}{\IfFileExists{newunicodechar.sty}{\usepackage{newunicodechar}}{\makeatletter\providecommand\newunicodechar[2]{%
...
\IfFileExists{fancyhdr.sty}{\IfFileExists{fancyhdr.sty}{\IfFileExists{fancyhdr.sty}{\usepackage{fancyhdr}}{}}{}}{}
\IfFileExists{graphicx.sty}{\IfFileExists{graphicx.sty}{\IfFileExists{graphicx.sty}{\usepackage{graphicx}}{}}{}}{}
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{{\fontsize{9.0}{10.8}\selectfont \includegraphics[height=15.75pt,keepaspectratio]{media/image4.jpeg} J. Stat. Appl. Pro. 185-201 (202 1 ) / http://www.naturalspublishing.com/Journals.asp \thepage}}
...
% Title block rendered inline (article's \mail{baha.shawaqfeh@wise.edu.jo}
\maketitle forces a page break when
% preceded by other content, which pushed the whole paper to page 2).
\begin{center}
  {\LARGE\bfseries Statistical Analysis of Body Dysmorphic Disorder, Quality of Life, and Social Anxiety in Fire Victims: Path Analysis\par}
  \vspace{1em}
  {\normalsize Abdallah Almahaireh$^{1}$, Baha' Shawaqfeh$^{2}$, Bahaa Eldeen Abu Serdaneh$^{3}$\par}
  \vspace{0.5em}
  {\small $^{1}$ Professor in Counselling and Special Education Department, School of Educational Science, The University of Jordan. \\ $^{2}$ Full-time lecturer in Counselling and Mental Health Department, Faculty of Educational Science, The World Islamic Sciences and Education University \\ $^{3}$ Ph.D. in Educational Psychology, School of Educational Science, The University of Jordan.\par}
\end{center}
\vspace{1em}
...
\noindent\textbf{Keywords:} Body Dysmorphic, Quality of Life, Social Anxiety, Fire Victims.
\vspace{1em}

\par\vspace{6.0pt}\noindent {\large\bfseries 1 Introduction\par}\vspace{12.0pt}

Fires is one of the common causes for injuries and death globally, which occur 180 thousand annually\cite{ref1}. In Jordan 21999 patients visits burn unit in governmental hospital \cite{ref2}. There is a lack of interest in burning injuries which need a long-term treatment which may happen to anyone, anywhere, and anytime. Burning May be caused by many factors such as gas, electricity, and hot water which result psychological and physical problems resulting decreasing in Quality of life (QOL) among fire victims.

QOL is affected by many variables related to burning such as; the response to injury, speed treatment response, quality of treatment, social support, and counselling \cite{ref3}. The QOL is defined as “the individual’s perception of their position in life in the context of culture and value systems in which they live and in relation to their goals, expectations, standards, and concerns” \cite{ref4}.

QOL is an extent of individual’s awareness of the experiences and how much he’s satisfied with his basic need fulfillment in life. Also, how much they feel happiness, accomplishment, and integration in terms of psychological, physical, cognitive, social, and emotional health \cite{ref5}. Fire victim’s QOL is affected by many aspects. Gautam et al., \cite{ref6} study found that burn injuries has a negative impact on QOL and its domains; psychology, physically, socially, and environmentally.

Fires harm the body physically and leads to marks and deformities which affect the individual’s body image. Fire victims could be experience body dysmorphic disorder symptoms (BDDS) that is defined as a disorder caused by a body defect in the external appearance that can be seen by others or can’t be seen\cite{ref7}. How the individual sees him self is very important because it develops his perception of self and how much he’s acceptable to others \cite{ref8}, the burning marks can lead the person to be not satisfied of his body and they know that others can see it which leads him to avoid social situations \cite{ref9}.

The social anxiety disorder symptoms (SADS) refers to a high level of anxiety happened when the individual faces social engagement and it leads him to avoid any interaction with others also it effects his life socially, occupationally, or on other functional areas \cite{ref10}. This can be affected negatively on their quality of life and leads them to isolation. Especially when they review the negative situations they have been exposed to, then evaluate them and create a negative thought about it, this affect their professional and social performance. It’s an important matter for the individual to feel healthy and psychologically wellbeing.

The best way to investigates these relations is by using path analysis method which is a statistical method investigate the direct, indirect, and total effects by mediating variable between at least two variables and it’s an extension method of multiple regression \cite{ref11}. This method helps in to test the theoretical model which assumed in this study that the SADS mediating the relationship between BDDS and QOL.
...
\par\medskip\noindent {\large\bfseries 1.1 Research questions\par}\smallskip
...
The researchers used a scale of 24 items from Al-Hasi \cite{ref12}. Participants rated each item on a four-Likert scale, from 1 (Strongly disagree) to 4 (Strongly agree). The researcher extracted the validity and reliability and found that the discriminate evidence ranged between 0.344 and 0.713. Cronbach’s alpha was 0.914.

2.3.2 Social Anxiety Disorder Symptoms Scale

The researchers used a scale of 10 items from Shawaqfeh \& Almahaireh \cite{ref13}. Participants rated each item on a four-Likert scale, from 1 (Strongly disagree) to 4 (Strongly agree). The researcher extracted the validity and reliability and found that the discriminate evidence ranged between 0.478 and 0.915. Cronbach’s alpha was 0.916.

2.3.3 Quality of Life Scale

The researchers used a scale of 24 items from Abu Al-wafaa \cite{ref14}. It’s including 4 dimensions (Physical, Psychological, Social Relationships, Environmental). Participants rated each item on a four-Likert scale, from 1 (Never) to 4 (Always). The researcher extracted the validity and reliability and found that the discriminate evidence ranged between 0.345 and 0.922. Cronbach’s alpha was ranged between 0.737-0.918.
...
\centering
{\small
\begin{tabular}{|>{\centering\arraybackslash}p{\dimexpr 0.4351\textwidth-2\tabcolsep\relax}|>{\centering\arraybackslash}p{\dimexpr 0.1570\textwidth-2\tabcolsep\relax}|>{\centering\arraybackslash}p{\dimexpr 0.1861\textwidth-2\tabcolsep\relax}|>{\centering\arraybackslash}p{\dimexpr 0.2208\textwidth-2\tabcolsep\relax}|}
\hline
...
\hline
\cellcolor[HTML]{DDD9C3}\textbf{BDDS} & 3.14 & .568 & High \\
\hline
\cellcolor[HTML]{DDD9C3}\textbf{QOL} & 2.29 & .169 & Moderate \\
\hline
\cellcolor[HTML]{DDD9C3}\textbf{SADS} & 3.08 & .704 & High \\
\hline
\end{tabular}}
...
\centering
{\small
\begin{tabular}{|>{\centering\arraybackslash}p{\dimexpr 0.2492\textwidth-2\tabcolsep\relax}|>{\centering\arraybackslash}p{\dimexpr 0.1319\textwidth-2\tabcolsep\relax}|>{\centering\arraybackslash}p{\dimexpr 0.1187\textwidth-2\tabcolsep\relax}|>{\centering\arraybackslash}p{\dimexpr 0.1318\textwidth-2\tabcolsep\relax}|>{\centering\arraybackslash}p{\dimexpr 0.1177\textwidth-2\tabcolsep\relax}|>{\centering\arraybackslash}p{\dimexpr 0.1318\textwidth-2\tabcolsep\relax}|>{\centering\arraybackslash}p{\dimexpr 0.1177\textwidth-2\tabcolsep\relax}|}
\hline
\multirow{2}{*}{\cellcolor[HTML]{DDD9C3}\textbf{Variable}} & \cellcolor[HTML]{DDD9C3}\textbf{BDDS} & \cellcolor[HTML]{DDD9C3} & \cellcolor[HTML]{DDD9C3}\textbf{QOL} & \cellcolor[HTML]{DDD9C3} & \cellcolor[HTML]{DDD9C3}\textbf{SADS} & \cellcolor[HTML]{DDD9C3} \\
\cline{2-7}
 & \cellcolor[HTML]{DDD9C3}\textbf{Correlation} & \cellcolor[HTML]{DDD9C3}\textbf{Sig.} & \cellcolor[HTML]{DDD9C3}\textbf{Correlation} & \cellcolor[HTML]{DDD9C3}\textbf{Sig.} & \cellcolor[HTML]{DDD9C3}\textbf{Correlation} & \cellcolor[HTML]{DDD9C3}\textbf{Sig.} \\
\hline
\cellcolor[HTML]{DDD9C3}\textbf{BDDS} & - & - & -.626* & .000 & .675* & .000 \\
\hline
\cellcolor[HTML]{DDD9C3}\textbf{QOL} & - & - & - & - & -.644* & .000 \\
\hline
\cellcolor[HTML]{DDD9C3}\textbf{SADS} & - & - & - & - & - & - \\
\hline
\end{tabular}}
\captionof{table}{Table}
\end{minipage}
...
\centering
{\small
\begin{tabular}{|>{\centering\arraybackslash}p{\dimexpr 0.3340\textwidth-2\tabcolsep\relax}|>{\centering\arraybackslash}p{\dimexpr 0.1766\textwidth-2\tabcolsep\relax}|>{\centering\arraybackslash}p{\dimexpr 0.1631\textwidth-2\tabcolsep\relax}|>{\centering\arraybackslash}p{\dimexpr 0.1629\textwidth-2\tabcolsep\relax}|>{\centering\arraybackslash}p{\dimexpr 0.1625\textwidth-2\tabcolsep\relax}|}
\hline
\multirow{2}{*}{\cellcolor[HTML]{DDD9C3}\textbf{Variable}} & \multicolumn{2}{c|}{\cellcolor[HTML]{DDD9C3}\textbf{Skewness}} & \multicolumn{2}{c|}{\cellcolor[HTML]{DDD9C3}\textbf{Kurtosis}} \\
\cline{2-5}
 & \cellcolor[HTML]{DDD9C3}\textbf{Statistic} & \cellcolor[HTML]{DDD9C3}\textbf{Std. Error} & \cellcolor[HTML]{DDD9C3}\textbf{Statistic} & \cellcolor[HTML]{DDD9C3}\textbf{Std. Error} \\
\hline
\cellcolor[HTML]{DDD9C3}\textbf{BDDS} & -.945 & .143 & .789 & .285 \\
\hline
\cellcolor[HTML]{DDD9C3}\textbf{QOL} & .398 & .143 & .954 & .285 \\
\hline
\cellcolor[HTML]{DDD9C3}\textbf{SADS} & -.426 & .143 & -.745 & .285 \\
\hline
\end{tabular}}
\captionof{table}{Table}
\end{minipage}
...
\begin{figure}[H]
\centering
\ifdim 3.9559in>\linewidth
  \includegraphics[width=\linewidth,keepaspectratio]{media/image5.png}
\else
  \includegraphics[width=3.9559in,height=2.3258in]{media/image5.png}
\fi
\end{figure}
...
\begin{figure}[H]
\centering
\ifdim 3.9924in>\linewidth
  \includegraphics[width=\linewidth,keepaspectratio]{media/image6.png}
\else
  \includegraphics[width=3.9924in,height=2.3473in]{media/image6.png}
\fi
\end{figure}
...
\begin{figure}[H]
\centering
\ifdim 3.8788in>\linewidth
  \includegraphics[width=\linewidth,keepaspectratio]{media/image7.png}
\else
  \includegraphics[width=3.8788in,height=2.2804in]{media/image7.png}
\fi
\end{figure}
...
Also, the model fit parameters were checked in table 4. The results show that the model is fit due to the CMIN/df=2.428, RMSEA= 0.069, and CFI= 0.739 according to Hair et al. \cite{ref16}.
...
\centering
{\small
\begin{tabular}{|>{\centering\arraybackslash}p{\dimexpr 0.2549\textwidth-2\tabcolsep\relax}|>{\centering\arraybackslash}p{\dimexpr 0.2487\textwidth-2\tabcolsep\relax}|>{\centering\arraybackslash}p{\dimexpr 0.2545\textwidth-2\tabcolsep\relax}|}
\hline
\cellcolor[HTML]{DDD9C3}\textbf{Model fit parameters} & \cellcolor[HTML]{DDD9C3}\textbf{Value} & \cellcolor[HTML]{DDD9C3}\textbf{Acceptable value} \\
\hline
\cellcolor[HTML]{DDD9C3}\textbf{CMIN/df} & 2.428 & Less than 5 \\
\hline
\cellcolor[HTML]{DDD9C3}\textbf{RMSEA} & 0.069 & Less than 0.1 \\
\hline
\cellcolor[HTML]{DDD9C3}\textbf{CFI} & 0.739 & Greater than 0.7 \\
\hline
\end{tabular}}
\captionof{table}{Table}
\end{minipage}
...
\begin{figure}[H]
\centering
\ifdim 4.0278in>\linewidth
  \includegraphics[width=\linewidth,keepaspectratio]{media/image8.png}
\else
  \includegraphics[width=4.0278in,height=5.0932in]{media/image8.png}
\fi
\end{figure}
...
\centering
{\small
\begin{tabular}{|>{\centering\arraybackslash}p{\dimexpr 0.1783\textwidth-2\tabcolsep\relax}|>{\centering\arraybackslash}p{\dimexpr 0.1783\textwidth-2\tabcolsep\relax}|>{\centering\arraybackslash}p{\dimexpr 0.1783\textwidth-2\tabcolsep\relax}|>{\centering\arraybackslash}p{\dimexpr 0.1783\textwidth-2\tabcolsep\relax}|>{\centering\arraybackslash}p{\dimexpr 0.1783\textwidth-2\tabcolsep\relax}|}
\hline
\cellcolor[HTML]{DDD9C3}\textbf{Independent} & \cellcolor[HTML]{DDD9C3}\textbf{Dependent} & \cellcolor[HTML]{DDD9C3}\textbf{Direct effect} & \cellcolor[HTML]{DDD9C3}\textbf{Indirect effect} & \cellcolor[HTML]{DDD9C3}\textbf{Total effect} \\
\hline
\cellcolor[HTML]{DDD9C3}\textbf{BDDS} & \cellcolor[HTML]{DDD9C3}\textbf{SADS} & .459 & - & .459 \\
\hline
\cellcolor[HTML]{DDD9C3}\textbf{BDDS} & \cellcolor[HTML]{DDD9C3}\textbf{QOL} & -.049 & -.300 & -.349 \\
\hline
\cellcolor[HTML]{DDD9C3}\textbf{SADS} & \cellcolor[HTML]{DDD9C3}\textbf{QOL} & -.654 & - & -.654 \\
\hline
\end{tabular}}
\captionof{table}{Table}
\end{minipage}
...
\centering
{\small
\begin{tabular}{|>{\centering\arraybackslash}p{\dimexpr 0.4445\textwidth-2\tabcolsep\relax}|>{\centering\arraybackslash}p{\dimexpr 0.4445\textwidth-2\tabcolsep\relax}|}
\hline
\cellcolor[HTML]{DDD9C3}\textbf{Variable} & \textbf{Estimate} \\
\hline
\cellcolor[HTML]{DDD9C3}\textbf{SADS} & .211 \\
\hline
\cellcolor[HTML]{DDD9C3}\textbf{QOL} & .460 \\
\hline
\end{tabular}}
\captionof{table}{Table}
\end{minipage}
...
These results show that the burn increases the BDDS, makes the person think others will not accept them, and look at them negatively. they focus on how others will judge them, and they feel humiliated when others look at them because of their burn marks \cite{ref17}. SADS makes QOL decrease because it affects how they deals with others and tries to avoid them, leading them to stay alone \cite{ref18}. Also, they may avoid going to their workplace because they feel ashamed and fears how others will assess them and their burn marks \cite{ref19}, which affect their occupational and social QOL. Emotionally, they suffered from negative feelings, pessimism, and low self-esteem related to the negative thinking about their body \cite{ref20}.
...
\bibitem{ref13}
Shawaqfeh, B. \& Almahaireh, A. (2022). Social Anxiety Disorder Symptoms among Divorced Women in Amman and the Differences in It According to Some Demographic Variables. Al-Quds Open University Journal For Research, 13 (38), 87-96.
...
\bibitem{ref15}
Garson, G. D. (2014). Path analysis (2nd ed.). Asheboro, NC: Statistical Associates Publishing.
...
\noindent\textbf{Abdallah Almahaireh}\\
\includegraphics[width=1in,height=1.25in,keepaspectratio]{media/image9.jpeg}\\
Abdallah Almahaireh is Counselling and Special Education Department, School of Educational Science, The University of Jordan. He received the Ph.D. degree in Educational and Psychological Counselling at The University of Jordan.\par\bigskip

\noindent\textbf{Baha' Shawaqfeh}\\
\includegraphics[width=1in,height=1.25in,keepaspectratio]{media/image10.jpeg}\\
Baha' Shawaqfeh is Full-time lecturer in Counselling and Mental Health Department, Faculty of Educational Science, The World Islamic Sciences and Education University. He received the Ph.D. degree in Educational and Psychological Counselling at The University of Jordan.\par\bigskip

\noindent\textbf{Bahaa Eldeen Abu Serdaneh}\\
\includegraphics[width=1in,height=1.25in,keepaspectratio]{media/image11.jpeg}\\
Bahaa Eldeen Abu Serdaneh has a Ph.D. degree in Educational Psychology, School of Educational Science, at The University of Jordan.\par\bigskip
