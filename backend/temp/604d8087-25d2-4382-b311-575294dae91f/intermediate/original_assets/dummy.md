...
**G.M. Vijayalakshmi ^1^, G. Susila^\*^ ^1,2^, ^3^P.Roselyn Besi,
^4,5,\*^Ali Akgül**
...
^3^Coimbatore Institute of Technology, Coimbatore-641014.
...
detrimental influence on mental health, social comparison, low
...
Key words: Scrolling addiction, Fractional -- order Caputo model,
Optimal control theory,

Numerical Simulation, Behavioural epidemiology, Digital health
intervention.
...
excessive and compulsive scrolling and sometimes accompanied by feelings
of guilt, anxiety and decreased productivity have been raised by this
increased \[1-10\] screen time.
...
integral of order $\alpha^{*}\epsilon R^{+}$, which is specified as
$I_{a +}^{\alpha^{*}}B(t) = \frac{1}{\Gamma(\alpha^{*})}\int_{0}^{t}{}{(t - s)}^{\alpha^{*} - 1}B(s)ds$.
(2.1)
...
${\ \ cD}_{0 +}^{\alpha^{*}}B(t) = \ \frac{1}{\Gamma(n - \alpha^{*})}\int_{0}^{t}{}(t - s)^{n - \alpha^{*} - 1}B^{n}(s)ds$
(2.2) $B(t) \in C^{n}\lbrack a,b\rbrack$ in this case,
$0 < \alpha^{*} < 1,\ \ n = \lbrack\alpha^{*}\rbrack + 1.$
...
![](G:\work\Journal2LaTeX\backend\temp\604d8087-25d2-4382-b311-575294dae91f\intermediate\media/media/image1.png){width="5.319717847769029in"
...
${\ E}_{1} = \left( S^{*},E^{*},I^{*},T^{*},R^{*},\ L^{*} \right)$ among
the population.
...
$\lambda - \frac{b\ SI}{N} - \xi S = 0$![](G:\work\Journal2LaTeX\backend\temp\604d8087-25d2-4382-b311-575294dae91f\intermediate\media/media/image7.png){width="1.3576388888888888in"
...
If we solve the above equations we
get![](G:\work\Journal2LaTeX\backend\temp\604d8087-25d2-4382-b311-575294dae91f\intermediate\media/media/image7.png){width="1.3576388888888888in"
height="2.328472222222222in"}

$S^{*}(t) = \frac{N}{R_{0}}$

$\ E^{*}(t) = \ \frac{\xi + \gamma - \sigma\ K}{\beta}{\ I}^{*} = \frac{(\xi + \gamma - \sigma\ K)(}{\beta}\frac{\xi N)}{b}(R_{0} - 1)$
...
$V = x_{1}\left( S - S^{*} - S^{*}\ In\ \frac{S}{S^{*}} \right) + x_{2}\left( E - E^{*} - E^{*}\ In\ \frac{E}{E^{*}} \right) + x_{3}\left( I - I^{*} - I^{*}\ In\ \frac{I}{I^{*}} \right)x_{4} + x_{4}\left( T - T^{*} - T^{*}\ In\ \frac{T}{T^{*}} \right) + x_{5}\left( R - R^{*} - R^{*}\ In\ \frac{R}{R^{*}} \right) + x_{6}\left( L - L^{*} - L^{*}\ In\ \frac{L}{L^{*}} \right)$
(4.8)
...
$V' = x_{1}\left( 1 - \frac{S}{S^{*}} \right)S' + x_{2}\left( 1 - \frac{E}{E^{*}} \right)E' + x_{3}\left( 1 - \frac{I}{I^{*}} \right)I' + x_{4}\left( \left( 1 - \frac{T}{T^{*}} \right)T' \right) + x_{5}\left( 1 - \frac{R}{R^{*}} \right)R' + x_{6}\left( 1 - \frac{L}{L^{*}} \right)L'$
(4.9)
...
$CD_{t}^{\alpha}\ S(t) = \lambda - \frac{b\ (1 - u_{1})SI}{N} - \xi S,$![](G:\work\Journal2LaTeX\backend\temp\604d8087-25d2-4382-b311-575294dae91f\intermediate\media/media/image9.png){width="0.8402777777777778in"
height="2.6395319335083114in"}
...
Theorem 5.1. Set $u_{1}^{*}$,$\ u_{2}^{*}$ and $u_{3}^{*}$ for the
control system of control variables . Then the control variable can be
expressed as

$\{ u_{1}^{*} = \left\{ 0,\left( 1,\frac{\left( \Phi_{1} - \Phi_{2} \right)SI}{c_{1}} \right)\  \right\}\ \ u_{2}^{*} = \left\{ 0,\left( 1,\frac{\left( \Phi_{2} - \Phi_{3} \right)I}{c_{2}} \right)\  \right\}\ \ u_{3}^{*} = \left\{ 0,\left( 1,\frac{\left( \Phi_{3} - \Phi_{6} \right)L}{c_{3}} \right)\  \right\}\ \$
(5.5)
...
2.png](G:\work\Journal2LaTeX\backend\temp\604d8087-25d2-4382-b311-575294dae91f\intermediate\media/media/image2.png){width="5.20625in"
...
![C:\\Users\\DELL\\Downloads\\ima
3.png](G:\work\Journal2LaTeX\backend\temp\604d8087-25d2-4382-b311-575294dae91f\intermediate\media/media/image3.png){width="5.206944444444445in"
...
![C:\\Users\\DELL\\Downloads\\ima
4.png](G:\work\Journal2LaTeX\backend\temp\604d8087-25d2-4382-b311-575294dae91f\intermediate\media/media/image4.png){width="5.206944444444445in"
height="3.6465277777777776in"}
...
![C:\\Users\\DELL\\Downloads\\ima
5.png](G:\work\Journal2LaTeX\backend\temp\604d8087-25d2-4382-b311-575294dae91f\intermediate\media/media/image5.png){width="5.206944444444445in"
height="3.6465277777777776in"}
...
6.png](G:\work\Journal2LaTeX\backend\temp\604d8087-25d2-4382-b311-575294dae91f\intermediate\media/media/image6.png){width="5.206944444444445in"
height="3.6465277777777776in"}
...
![C:\\Users\\DELL\\Downloads\\ima
7.png](G:\work\Journal2LaTeX\backend\temp\604d8087-25d2-4382-b311-575294dae91f\intermediate\media/media/image8.png){width="5.206944444444445in"
height="3.6465277777777776in"}
...
9.Young, K.S., Cognitive behavior therapy with internet addicts:
Treatment outcomes and implications. Cyber psychology & Behavior. 10 (5)
(2007) 671-679.

10\. Egger, O., & Rauterberg, M., Internet behaviour and addiction.
Semester thesis (Swiss Federal Institute of Technology.(1996).
