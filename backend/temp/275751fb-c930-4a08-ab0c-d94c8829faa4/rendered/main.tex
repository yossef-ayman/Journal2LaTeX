...
\author{G.M. Vijayalakshmi$^{1}$ \and G. Susila*$^{1}$ \and 3P.Roselyn Besi \and *Ali Akgül$^{2}$ \and Numerical Simulation \and Behavioural epidemiology \and Digital health intervention. \and Contents \and 1. Introduction \and 2. Fractional Elementary Concepts \and 3. Model Formulation \and 4. Stability analysis \and 5. Optimal Control Theory \and 6. Numerical simulation \and 7. Conclusion \and The basic definitions are presented related to fractional calculus. \and Definition 2.1 RLFI [Riemann – Liouville fractional integral] \and Definition 2.2 CFOD [Caputo – Fractional Order Derivative] \and The function's Caputo fractional-order derivative is}
