...
\author{G.M. Vijayalakshmi$^{1}$ \and G. Susila*$^{1}$ \and Z. Che Muda$^{2}$ \and Sudesh Nair Baskara$^{2}$ \and P. Roselyn Besi$^{3}$ \and Ali Akgül$^{4}$ \and Numerical Simulation \and Behavioural epidemiology \and Mental health intervention. \and Contents \and 1. Introduction \and 2. Fractional Elementary Concepts \and 3. Model Formulation \and 4. Stability analysis \and 5. Optimal Control Theory \and 6. Numerical simulation \and 7. Conclusion \and The basic definitions are presented related to fractional calculus. \and Definition 2.1 RLFI [Riemann – Liouville fractional integral] \and Definition 2.2 CFOD [Caputo – Fractional Order Derivative] \and The function's Caputo fractional-order derivative is}

\institute{$^{1}$ Department of Mathematics, Vel Tech Rangarajan Dr. Sagunthala R \& D Institute of Science and Technology, Avadi, Tamil Nadu, 600 062, India. \\ $^{2}$ Department of Civil Engineering, Faculty of Engineering and Quantity Surveyor, INTI International University, 71800 Nilai, Negeri Sembilan, Malaysia \\ $^{3}$ Coimbatore Institute of Technology, Coimbatore-641014. \\ $^{4}$ Siirt University, Art and Science Faculty, Department of Mathematics, 56100 Siirt, Türkiye}
...
\centering
{\small
\begin{tabular}{|p{\dimexpr 0.1971\textwidth-2\tabcolsep\relax}|p{\dimexpr 0.1970\textwidth-2\tabcolsep\relax}|p{\dimexpr 0.1971\textwidth-2\tabcolsep\relax}|}
\hline
\textbf{Parameters
...
\bibitem{ref36}
Lei Shi a, Jiaying Zhou, Yong Ye., Global stability and Hopf bifurcation of networked respiratory disease model with delay, 151 (2024) 109000.

\bibitem{ref37}
HF Huo, Q Wang., Modelling the inﬂuence of awareness programs by media on the drinking dynamics. Abstract and Applied Analysis, 2014(1)(2014) 938080.
...
\bibitem{ref40}
Abdon Atangana, Seda Igret.,Fractional Stochastic Diﬀerential Equations. Springer,
