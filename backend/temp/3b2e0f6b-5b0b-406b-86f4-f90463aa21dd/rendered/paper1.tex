...
\author{G.M. Vijayalakshmi$^{1}$, G. Susila$^{1,2}$, Z. Che Muda$^{3}$, Sudesh Nair Baskara$^{3}$, P. Roselyn Besi$^{4}$, Ali Akg\"ul$^{5,6,*}$, M. Abdel-Aty$^{7,8,9}$ and M. Hafez$^{10,11}$}

\institute{Department of Mathematics, Vel Tech Rangarajan Dr. Sagunthala R \& D Institute of Science and Technology, Avadi, Tamil Nadu, 600 062, India\and
	Meenakshi College of Engineering, Chennai-78, India\and
	Department of Civil Engineering, Faculty of Engineering and Quantity Surveying, INTI International University, 71800 Nilai, Negeri Sembilan, Malaysia\and
	Coimbatore Institute of Technology, Coimbatore-641014, India\and
	Department of Electronics and Communication Engineering, Saveetha School of Engineering, SIMATS, Chennai, Tamilnadu, India\and
	Siirt University, Art and Science Faculty, Department of Mathematics, 56100 Siirt, T\"urkiye\and
	College of Engineering and Computing, Liwa University, Abu Dhabi, United Arab Emirates\and
	Deanship of Graduate Studies and Research, Ahlia University, P.O. Box 10878, Manama, Bahrain\and
	Mathematics Department, Faculty of Science, Sohag University, P.O. Box 82524, Sohag, Egypt\and
	Faculty of Engineering and Quantity Surveying, INTI International University Colleges, Nilai, Malaysia\and
...
\authorrunning{G.M. Vijayalakshmi et al.}
	...
	\titlerunning{Optimal control strategies for overwhelming social media scrolling addiction}
	\authorrunning{G.M. Vijayalakshmi et al.}
	
	\mail{aliakgul@siirt.edu.tr, susimohi@gmail.com,amisaty@gmail.com, mohdahmed.hafez@newinti.edu.my }
	...
	\begin{figure}[H]
		...
		\else
		\includegraphics[width=5.3194in,height=4.0833in]{media/fig1.png}
		\fi
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.8\linewidth]{media/fig2.png}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.8\linewidth]{media/fig3.png}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.8\linewidth]{media/fig4.png}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.8\linewidth]{media/fig5.png}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.8\linewidth]{media/fig6.png}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.8\linewidth]{media/fig7.png}
